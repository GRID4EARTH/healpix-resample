...
plus solution time was 0.37~s for a $256\times256$ patch on an NVIDIA A100.
...
under-restores. Full image and spectral panels are supplied in the supplement.
...
On an NVIDIA A100 80~GB PCIe system, over 357 $256\times256$ patches the
...
batch sweep in the supplement observed a 10.3$\times$ amortized
