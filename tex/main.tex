...
geometry. The mathematical construction depends only on sample
geolocations and a local spatial-response model; the released interface and
the validation reported here are narrower, using a scalar isotropic Gaussian
and Sentinel-2 B04 imagery.
