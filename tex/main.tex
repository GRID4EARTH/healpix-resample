...
\cite{healpix_resample_repo}. Frozen Sentinel-2 and Esri inputs are archived
on Zenodo under DOI \url{https://doi.org/10.5281/zenodo.22107490}
\cite{healpix_resample_paper_data}; the repository provides a verified loader
for installing them at the expected paths.
