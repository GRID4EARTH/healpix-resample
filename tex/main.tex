...
plus solution time was 0.315~s for a $256\times256$ patch on an NVIDIA A100.
...
On an NVIDIA A100 80~GB PCIe system, median operator construction plus solve
time over 357 $256\times256$ patches is 0.315~s (interquartile range
0.312--0.320~s); construction accounts for 87\% and the solve for 13\%.
...
batch sweep in the supplement observed an 8.6--10.0$\times$ amortized
